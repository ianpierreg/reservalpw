			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php else:?>
							<h5>Selecione a reserva que prestará serviço hoje</h5>
							<?php $usuarioReserva = UsuarioHasReserva::findAll(['usuario_id' => Yii::$app->user->id]);
							      $reservas = [];
								  foreach ($usuarioReserva as $users){
									$reserva = Reserva::findOne($users->reserva_id);
								  	$reservas[]= $reserva;

								  }
							?>
							<?= Html::dropDownList("reserva", null, ArrayHelper::map($reservas, 'id', 'descricao'), [
								'prompt' => 'Selecione a reserva ...',
							]); ?>
						<?php endif ?>

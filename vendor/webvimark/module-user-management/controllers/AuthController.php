...
class AuthController extends BaseController
{
	...
	{
	    if(Yii::$app->request->post('reserva') != null) {
            if(!isset(Yii::$app->session)){
                @session_start();
            }

            Yii::$app->session['reserva'] = Yii::$app->request->post('reserva');
            return $this->goBack();
	...
	public function actionLogout()
	{
        ...
        Yii::$app->session['reserva'] = null;
        @session_destroy();
            Yii::$app->user->logout();

		return $this->redirect(Url::base() . "/user-management/auth/login");
	}

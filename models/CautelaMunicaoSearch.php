...
/**
 * CautelaMunicaoSearch represents the model behind the search form about `app\models\CautelaMunicao`.
 */
class CautelaMunicaoSearch extends CautelaMunicao
{
    /**
     * @inheritdoc
     */
